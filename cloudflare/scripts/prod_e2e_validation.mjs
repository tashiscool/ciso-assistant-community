...
const ROUTE_CHECKS = [
  ...
  { group: 'ops', path: '/grc-admin/scrutiny-engine', expectAny: ['Scrutiny', 'Assessor'] },
  ...
  { group: 'evidence', path: '/assessment-evidence-packages', expectAny: ['Assessment Evidence', 'Evidence Packages'] },
