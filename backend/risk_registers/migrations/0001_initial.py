        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "risk_title",
                    models.CharField(
                        help_text="Title/description of the risk", max_length=500
                    ),
                ),
                (
                    "risk_description",
                ...
                (
                    "cve_ids",
                    models.JSONField(
                        blank=True, default=list, help_text="Associated CVE identifiers"
                    ),
                ),
                (
                    "cwe_ids",
                    models.JSONField(
                        blank=True, default=list, help_text="Associated CWE identifiers"
                    ),
                ),
                (
                    "cvss_base_score",
                    models.FloatField(
                        default=0.0, help_text="CVSS base score (0.0-10.0)"
                    ),
                ),
                (
                    "cvss_temporal_score",
                    models.FloatField(default=0.0, help_text="CVSS temporal score"),
                ),
                (
                    "cvss_environmental_score",
                    models.FloatField(
                        default=0.0, help_text="CVSS environmental score"
                    ),
                ),
                (
                    "inherent_likelihood",
                    models.IntegerField(
                        default=1, help_text="Inherent likelihood score (1-5)"
                    ),
                ),
                (
                    "inherent_impact",
                    models.IntegerField(
                        default=1, help_text="Inherent impact score (1-5)"
                    ),
                ),
                (
                    "inherent_risk_score",
                    models.IntegerField(
                        default=1, help_text="Inherent risk score (calculated)"
                    ),
                ),
                (
                    "residual_likelihood",
                    models.IntegerField(
                        default=1, help_text="Residual likelihood after controls"
                    ),
                ),
                (
                    "residual_impact",
                    models.IntegerField(
                        default=1, help_text="Residual impact after controls"
                    ),
                ),
                (
                    "residual_risk_score",
                    models.IntegerField(
                        default=1, help_text="Residual risk score (calculated)"
                    ),
                ),
                (
                    "inherent_risk_level",
                ...
                (
                    "risk_threshold",
                    models.IntegerField(
                        default=3, help_text="Risk score threshold for treatment (1-5)"
                    ),
                ),
                (
                    "requires_treatment",
                    models.BooleanField(
                        default=False, help_text="Whether this risk requires treatment"
                    ),
                ),
                (
                    "treatment_strategy",
                ...
                (
                    "treatment_plan",
                    models.TextField(
                        blank=True, help_text="Detailed treatment plan", null=True
                    ),
                ),
                (
                    "treatment_owner_user_id",
                    models.UUIDField(
                        blank=True,
                        db_index=True,
                ...
                (
                    "last_review_date",
                    models.DateField(
                        blank=True, help_text="Date of last risk review", null=True
                    ),
                ),
                (
                    "next_review_date",
                ...
                (
                    "review_notes",
                    models.TextField(
                        blank=True, help_text="Notes from risk reviews", null=True
                    ),
                ),
                (
                    "risk_owner_user_id",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["asset_id", "residual_risk_level"],
                        name="asset_risk_level_idx",
                    ),
                    models.Index(
                        fields=["risk_category"], name="asset_risk_category_idx"
                    ),
                    models.Index(
                        fields=["treatment_status"], name="asset_risk_treatment_idx"
                    ),
                    models.Index(
                        fields=["next_review_date"], name="asset_risk_review_idx"
                    ),
                    models.Index(
                        fields=["requires_treatment"], name="asset_risk_treat_req_idx"
                    ),
                    models.Index(
                        fields=["residual_risk_score"], name="asset_risk_score_idx"
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the risk register", max_length=255
                    ),
                ),
                (
                    "description",
                ...
                (
                    "total_risks",
                    models.IntegerField(
                        default=0, help_text="Total number of risks in the register"
                    ),
                ),
                (
                    "critical_risks",
                    models.IntegerField(
                        default=0, help_text="Number of critical risks"
                    ),
                ),
                (
                    "high_risks",
                    models.IntegerField(default=0, help_text="Number of high risks"),
                ),
                (
                    "moderate_risks",
                    models.IntegerField(
                        default=0, help_text="Number of moderate risks"
                    ),
                ),
                (
                    "low_risks",
                    models.IntegerField(default=0, help_text="Number of low risks"),
                ),
                (
                    "risks_requiring_treatment",
                    models.IntegerField(
                        default=0, help_text="Number of risks requiring treatment"
                    ),
                ),
                (
                    "risks_under_treatment",
                    models.IntegerField(
                        default=0, help_text="Number of risks currently under treatment"
                    ),
                ),
                (
                    "risks_effectively_treated",
                    models.IntegerField(
                        default=0, help_text="Number of risks with effective treatment"
                    ),
                ),
                (
                ...
                (
                    "risk_appetite_critical_threshold",
                    models.IntegerField(
                        default=20, help_text="Risk score threshold for critical risks"
                    ),
                ),
                (
                    "risk_appetite_high_threshold",
                    models.IntegerField(
                        default=15, help_text="Risk score threshold for high risks"
                    ),
                ),
                (
                    "risk_appetite_moderate_threshold",
                    models.IntegerField(
                        default=10, help_text="Risk score threshold for moderate risks"
                    ),
                ),
                (
                    "reporting_frequency",
                ...
                (
                    "last_report_date",
                    models.DateField(
                        blank=True, help_text="Date of last risk report", null=True
                    ),
                ),
                (
                    "next_report_date",
                    models.DateField(
                        blank=True, help_text="Date of next scheduled report", null=True
                    ),
                ),
                (
                    "last_review_date",
                    models.DateField(
                        blank=True, help_text="Date of last register review", null=True
                    ),
                ),
                (
                    "next_review_date",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["owner_user_id"], name="risk_register_owner_idx"
                    ),
                    models.Index(
                        fields=["next_report_date"], name="risk_register_report_idx"
                    ),
                    models.Index(
                        fields=["next_review_date"], name="risk_register_review_idx"
                    ),
                    models.Index(
                        fields=["total_risks"], name="risk_register_total_risks_idx"
                    ),
                    models.Index(
                        fields=["critical_risks"], name="risk_register_critical_idx"
                    ),
                    models.Index(
                        fields=["created_at"], name="risk_register_created_idx"
                    ),
                ],
            },
        ),
