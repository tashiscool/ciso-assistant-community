    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "points",
                    models.IntegerField(
                        default=0, help_text="Points awarded for correct/best answer"
                    ),
                ),
                (
                    "conditional_logic",
                ...
                (
                    "order",
                    models.IntegerField(
                        default=0, help_text="Display order within questionnaire"
                    ),
                ),
                (
                    "section",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(help_text="Questionnaire title", max_length=255),
                ),
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Questionnaire description", null=True
                    ),
                ),
                (
                    "questionnaire_type",
                ...
                (
                    ...
                    models.CharField(
                        default="1.0", help_text="Questionnaire version", max_length=20
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=True, help_text="Whether authentication is required"
                    ),
                ),
                (
                    "enable_scoring",
                    models.BooleanField(
                        default=True, help_text="Whether questionnaire supports scoring"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=True, help_text="Whether users can navigate backwards"
                    ),
                ),
                (
                    "show_progress_bar",
                    models.BooleanField(
                        default=True, help_text="Whether to show progress indicator"
                    ),
                ),
                (
                    "introduction_text",
                ...
                (
                    "completion_message",
                    models.TextField(
                        blank=True, help_text="Message shown upon completion", null=True
                    ),
                ),
                (
                    "tags",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["status", "questionnaire_type"],
                        name="questionnaire_status_type_idx",
                    ),
                    models.Index(
                        fields=["category"], name="questionnaire_category_idx"
                    ),
                    models.Index(
                        fields=["created_at"], name="questionnaire_created_idx"
                    ),
                    models.Index(
                        fields=["usage_count"], name="questionnaire_usage_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "questionnaire_id",
                    models.UUIDField(
                        db_index=True, help_text="ID of the questionnaire being taken"
                    ),
                ),
                (
                    "user_id",
                ...
                (
                    "questions_answered",
                    models.IntegerField(
                        default=0, help_text="Number of questions answered so far"
                    ),
                ),
                (
                    "total_questions",
                ...
                (
                    "enable_scoring",
                    models.BooleanField(
                        default=False, help_text="Whether this run supports scoring"
                    ),
                ),
                (
                    "current_score",
                    models.IntegerField(
                        default=0, help_text="Current score accumulated"
                    ),
                ),
                (
                    "max_possible_score",
                    models.IntegerField(
                        default=0, help_text="Maximum possible score for this run"
                    ),
                ),
                (
                    "passing_score",
                ...
                (
                    ...
                    models.FloatField(
                        blank=True, help_text="Final score as percentage", null=True
                    ),
                ),
                (
                    "passed",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["questionnaire_id", "status"],
                        name="run_questionnaire_status_idx",
                    ),
                    models.Index(
                        fields=["user_id", "status"], name="run_user_status_idx"
                    ),
                    models.Index(
                        fields=["status", "started_at"], name="run_status_started_idx"
                    ),
                    models.Index(
                        fields=["session_token"], name="run_session_token_idx"
                    ),
