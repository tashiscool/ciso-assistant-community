...
This project uses **Playwright** for end-to-end (E2E) tests that allow comprehensive testing of the Regovise application by simulating real user interactions.
