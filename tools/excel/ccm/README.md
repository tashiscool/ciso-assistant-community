...
- Run the preparation script by passing the filename as 1st argument and your name/entity as a second one for the packager (e.g. `./convert_ccm.sh ./CCMv4.xlsx ciso`). Use `convert_ccm.bat` if you're on Windows, or `convert_ccm.sh` if you're on Linux/Mac.
